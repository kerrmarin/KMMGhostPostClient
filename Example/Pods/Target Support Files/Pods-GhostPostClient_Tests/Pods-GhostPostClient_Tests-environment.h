...
// GhostPostClient
#define COCOAPODS_POD_AVAILABLE_GhostPostClient
#define COCOAPODS_VERSION_MAJOR_GhostPostClient 0
#define COCOAPODS_VERSION_MINOR_GhostPostClient 1
#define COCOAPODS_VERSION_PATCH_GhostPostClient 0
